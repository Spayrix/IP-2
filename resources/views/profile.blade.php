        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="text-center mb-4">
                    <img src="{{ $user->avatar ?? 'default-avatar.png' }}" alt="Avatar" class="img-fluid rounded-circle" style="width: 150px; height: 150px;">
                ...
                <form action="{{ route('profile.update') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="age" id="age" class="form-control form-control-sm" value="{{ $user->age }}" required>
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <ul class="mt-3">
                    @foreach($addresses as $address)
                        <li>{{ $address->title }} - {{ $address->address_line }}</li>
                    @endforeach
                </ul>
            </div>
